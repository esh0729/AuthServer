...
namespace WebCommon
{
	public class PDGameConfig : PacketData
	{
		...
		public void Set(DataRow dr)
		{
			...
			startContinentId = Convert.ToInt32(dr["startContinentId"]);
			startXPosition = Convert.ToSingle(dr["startXPosition"]);
			startYPosition = Convert.ToSingle(dr["startYPosition"]);
			startZPosition = Convert.ToSingle(dr["startZPosition"]);
			startRadius = Convert.ToSingle(dr["startRadius"]);
			startYRotationType = Convert.ToInt32(dr["startYRotationType"]);
			startYRotation = Convert.ToSingle(dr["startYRotation"]);
			heroCreationLimitCount = Convert.ToInt32(dr["heroCreationLimitCount"]);
		}
	}
}
